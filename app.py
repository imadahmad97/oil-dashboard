...
app.title = "Imad's Oil Production Dashboard"
server = app.server
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.H5(
                                    "Imad Ahmad", style={"margin-top": "0px",
                                                         "color": "white"}
                                ),
                            ]
                        )
...
def filter_dataframe(df, well_statuses, well_types, year_slider):
    dff = df[
        ...
        & (df["Date_Well_Completed"] > dt.datetime(int(year_slider[0]), 1, 1))
        & (df["Date_Well_Completed"] < dt.datetime(int(year_slider[1]), 1, 1))
    ]
    return dff
